...
app.title = "Attractivité fiscale des territoires pour les entreprises"
server = app.server
...
app.layout = html.Div(
    ...
    children=[
        html.Div(
            ...
            children=[
                html.A(
                    html.Img(id="logo", src=app.get_asset_url("logo_dgfip.svg")),
                    href="https://www.economie.gouv.fr/dgfip",
                ),
                html.H4(children="Attractivité fiscale des territoires pour les entreprises"),
                html.P(
                    id="description",
...
def update_map_title(year):
    return "Cotisation foncière des entreprises par commune (16)"
